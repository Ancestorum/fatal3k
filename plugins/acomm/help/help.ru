...
acomm.exam = %prefix%acomm caps: tkabber := say Приветствуем тебя пользователь Tkabber'а!
acomm.exam = %prefix%acomm cvar/2: get_revision() := say Вышла новая ревизия бота!
