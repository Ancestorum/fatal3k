alias_add.ccat = admin, alias, all, *
...
galias_add.ccat = superadmin, alias, all, *
...
alias_del.ccat = admin, alias, all, *
...
galias_del.ccat = superadmin, alias, all, *
...
alias_exp.ccat = admin, alias, info, all, *
...
galias_exp.ccat = superadmin, alias, info, all, *
...
alias_show.ccat = admin, alias, info, all, *
...
galias_show.ccat = superadmin, alias, info, all, *
...
alias_list.ccat = alias, info, all, *
...
alias_acc.ccat = admin, alias, all, *
...
galias_acc.ccat = superadmin, alias, all, *
