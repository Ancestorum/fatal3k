...
globmsg.ccat = superadmin, muc, all, *
...
remote.ccat = superadmin, muc, all, *
...
bot_lang.ccat = *, all, locale, superadmin
...
connect.ccat = superadmin, accounts, all, *
...
disconnect.ccat = superadmin, accounts, all, *
...
syslog.ccat = superadmin, info, all, *
...
config.ccat = superadmin, config, all, *
